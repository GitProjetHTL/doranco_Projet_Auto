...
<form id="headerForm" action="" class=" mx-auto d-flex" method="post">
    ...
    <div class="form-floating">
        <input type="datetime-local" class="form-control <?= isset($_SESSION['error']['filter']['date_heure_depart']) ? "is-invalid" : "" ?>" id="date_heure_depart" name="date_heure_depart" placeholder="Début de location" value=" <?= $formData ?>">
    ...
    <div class="form-floating">
        <input type="datetime-local" class="form-control  <?= isset($_SESSION['error']['filter']['date_heure_fin']) ? "is-invalid" : "" ?>" id="date_heure_fin" name="date_heure_fin" placeholder="Fin de location">
