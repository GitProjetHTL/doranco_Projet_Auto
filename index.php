...
<?php 
    ...
    // 
        if(isConnected() && isset($_GET['action'] ) &&  $_GET['action']=='book'){
            ...
            //SI le nomb dejour est definie alors c'est que je suis passe par toutes les verification faites plus haut
            if(isset($_SESSION['data']['total_days'])){
                ...
                if ($success) {
                    ...
                    $_SESSION['success']="Commande enregistre";
                    unset($_SESSION['data']);
                ...
                $_SESSION['error']['filter']['date_heure_depart']= "Merci de sélectionner une date de départ et du de retour";
